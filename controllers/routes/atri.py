...
class Atri:
	def __init__(self, state: Any):
		...
		self.home_hero_section = state["home_hero_section"]
		self.home_hero_section_flex = state["home_hero_section_flex"]
		self.home_hero_section_wrapper_text = state["home_hero_section_wrapper_text"]
		self.Flex10 = state["Flex10"]
		self.button_flex_1 = state["button_flex_1"]
		self.button_flex_2 = state["button_flex_2"]
		self.home_hero_section_wrapper_image = state["home_hero_section_wrapper_image"]
		self.header = state["header"]
		self.header_flex = state["header_flex"]
		self.header_flex_menu = state["header_flex_menu"]
		self.trusted_by_section = state["trusted_by_section"]
		self.trusted_by_section_wrapper = state["trusted_by_section_wrapper"]
		...
		self.services_2 = state["services_2"]
		...
		self.services_3 = state["services_3"]
		...
		self.projects_section = state["projects_section"]
		self.Flex79 = state["Flex79"]
		self.Flex81 = state["Flex81"]
		self.Flex82 = state["Flex82"]
		self.Flex80 = state["Flex80"]
		self.product_designer_section = state["product_designer_section"]
		...
		self.edu_and_we = state["edu_and_we"]
		...
		self.main_head_section_colored = state["main_head_section_colored"]
		self.main_head_section = state["main_head_section"]
		self.home_hero_section_text_desc = state["home_hero_section_text_desc"]
		self.button_flex_1_text = state["button_flex_1_text"]
		self.TextBox14 = state["TextBox14"]
		self.man_asset_image = state["man_asset_image"]
		self.Image1 = state["Image1"]
		self.menu_options_about = state["menu_options_about"]
		self.menu_options_service = state["menu_options_service"]
		self.menu_options_projects = state["menu_options_projects"]
		self.menu_options_blog = state["menu_options_blog"]
		self.menu_options_book = state["menu_options_book"]
		self.TextBox15 = state["TextBox15"]
		self.trusted_by_1 = state["trusted_by_1"]
		self.trusted_by_2 = state["trusted_by_2"]
		self.trusted_by_3 = state["trusted_by_3"]
		self.trusted_by_4 = state["trusted_by_4"]
		self.TextBox16 = state["TextBox16"]
		self.TextBox17 = state["TextBox17"]
		self.services_1_image = state["services_1_image"]
		...
		self.services_2_image = state["services_2_image"]
		...
		self.services_3_image = state["services_3_image"]
		...
		self.productDesginer1_image = state["productDesginer1_image"]
		self.productDesginer2_image = state["productDesginer2_image"]
		self.productDesginer3_image = state["productDesginer3_image"]
		self.productDesginer4_image = state["productDesginer4_image"]
		self.TextBox57 = state["TextBox57"]
		self.TextBox58 = state["TextBox58"]
		self.TextBox59 = state["TextBox59"]
		self.TextBox60 = state["TextBox60"]
		self.we_1_image = state["we_1_image"]
		...
		self.Accordion8 = state["Accordion8"]
		self.Accordion9 = state["Accordion9"]
		self.Accordion19 = state["Accordion19"]
		self.Accordion6 = state["Accordion6"]
		self.Accordion7 = state["Accordion7"]
		self.Accordion10 = state["Accordion10"]
	...
	@property
	def home_hero_section(self):
		self._getter_access_tracker["home_hero_section"] = {}
		return self._home_hero_section
	@home_hero_section.setter
	def home_hero_section(self, new_state):
		self._setter_access_tracker["home_hero_section"] = {}
		global default_state
		self._home_hero_section = Flex(new_state, default_state["home_hero_section"])

	@property
	def home_hero_section_flex(self):
		self._getter_access_tracker["home_hero_section_flex"] = {}
		return self._home_hero_section_flex
	@home_hero_section_flex.setter
	def home_hero_section_flex(self, new_state):
		self._setter_access_tracker["home_hero_section_flex"] = {}
		global default_state
		self._home_hero_section_flex = Flex(new_state, default_state["home_hero_section_flex"])

	@property
	def home_hero_section_wrapper_text(self):
		self._getter_access_tracker["home_hero_section_wrapper_text"] = {}
		return self._home_hero_section_wrapper_text
	@home_hero_section_wrapper_text.setter
	def home_hero_section_wrapper_text(self, new_state):
		self._setter_access_tracker["home_hero_section_wrapper_text"] = {}
		global default_state
		self._home_hero_section_wrapper_text = Flex(new_state, default_state["home_hero_section_wrapper_text"])
	...
	@property
	def button_flex_1(self):
		self._getter_access_tracker["button_flex_1"] = {}
		return self._button_flex_1
	@button_flex_1.setter
	def button_flex_1(self, new_state):
		self._setter_access_tracker["button_flex_1"] = {}
		global default_state
		self._button_flex_1 = Flex(new_state, default_state["button_flex_1"])

	@property
	def button_flex_2(self):
		self._getter_access_tracker["button_flex_2"] = {}
		return self._button_flex_2
	@button_flex_2.setter
	def button_flex_2(self, new_state):
		self._setter_access_tracker["button_flex_2"] = {}
		global default_state
		self._button_flex_2 = Flex(new_state, default_state["button_flex_2"])

	@property
	def home_hero_section_wrapper_image(self):
		self._getter_access_tracker["home_hero_section_wrapper_image"] = {}
		return self._home_hero_section_wrapper_image
	@home_hero_section_wrapper_image.setter
	def home_hero_section_wrapper_image(self, new_state):
		self._setter_access_tracker["home_hero_section_wrapper_image"] = {}
		global default_state
		self._home_hero_section_wrapper_image = Flex(new_state, default_state["home_hero_section_wrapper_image"])
	...
	@property
	def header_flex(self):
		self._getter_access_tracker["header_flex"] = {}
		return self._header_flex
	@header_flex.setter
	def header_flex(self, new_state):
		self._setter_access_tracker["header_flex"] = {}
		global default_state
		self._header_flex = Flex(new_state, default_state["header_flex"])

	@property
	def header_flex_menu(self):
		self._getter_access_tracker["header_flex_menu"] = {}
		return self._header_flex_menu
	@header_flex_menu.setter
	def header_flex_menu(self, new_state):
		self._setter_access_tracker["header_flex_menu"] = {}
		global default_state
		self._header_flex_menu = Flex(new_state, default_state["header_flex_menu"])

	@property
	def trusted_by_section(self):
		self._getter_access_tracker["trusted_by_section"] = {}
		return self._trusted_by_section
	@trusted_by_section.setter
	def trusted_by_section(self, new_state):
		self._setter_access_tracker["trusted_by_section"] = {}
		global default_state
		self._trusted_by_section = Flex(new_state, default_state["trusted_by_section"])

	@property
	def trusted_by_section_wrapper(self):
		self._getter_access_tracker["trusted_by_section_wrapper"] = {}
		return self._trusted_by_section_wrapper
	@trusted_by_section_wrapper.setter
	def trusted_by_section_wrapper(self, new_state):
		self._setter_access_tracker["trusted_by_section_wrapper"] = {}
		global default_state
		self._trusted_by_section_wrapper = Flex(new_state, default_state["trusted_by_section_wrapper"])
	...
	def services_section(self):
		self._getter_access_tracker["services_section"] = {}
		return self._services_section
	@services_section.setter
	def services_section(self, new_state):
		self._setter_access_tracker["services_section"] = {}
		global default_state
		self._services_section = Flex(new_state, default_state["services_section"])
	...
	@property
	def services_1(self):
		self._getter_access_tracker["services_1"] = {}
		return self._services_1
	@services_1.setter
	def services_1(self, new_state):
		self._setter_access_tracker["services_1"] = {}
		global default_state
		self._services_1 = Flex(new_state, default_state["services_1"])
	...
	@property
	def services_2(self):
		self._getter_access_tracker["services_2"] = {}
		return self._services_2
	@services_2.setter
	def services_2(self, new_state):
		self._setter_access_tracker["services_2"] = {}
		global default_state
		self._services_2 = Flex(new_state, default_state["services_2"])
	...
	@property
	def services_3(self):
		self._getter_access_tracker["services_3"] = {}
		return self._services_3
	@services_3.setter
	def services_3(self, new_state):
		self._setter_access_tracker["services_3"] = {}
		global default_state
		self._services_3 = Flex(new_state, default_state["services_3"])
	...
	def projects_section(self):
		self._getter_access_tracker["projects_section"] = {}
		return self._projects_section
	@projects_section.setter
	def projects_section(self, new_state):
		self._setter_access_tracker["projects_section"] = {}
		global default_state
		self._projects_section = Flex(new_state, default_state["projects_section"])
	...
	@property
	def product_designer_section(self):
		self._getter_access_tracker["product_designer_section"] = {}
		return self._product_designer_section
	@product_designer_section.setter
	def product_designer_section(self, new_state):
		self._setter_access_tracker["product_designer_section"] = {}
		global default_state
		self._product_designer_section = Flex(new_state, default_state["product_designer_section"])
	...
	@property
	def edu_and_we(self):
		self._getter_access_tracker["edu_and_we"] = {}
		return self._edu_and_we
	@edu_and_we.setter
	def edu_and_we(self, new_state):
		self._setter_access_tracker["edu_and_we"] = {}
		global default_state
		self._edu_and_we = Flex(new_state, default_state["edu_and_we"])
	...
	@property
	def main_head_section_colored(self):
		self._getter_access_tracker["main_head_section_colored"] = {}
		return self._main_head_section_colored
	@main_head_section_colored.setter
	def main_head_section_colored(self, new_state):
		self._setter_access_tracker["main_head_section_colored"] = {}
		global default_state
		self._main_head_section_colored = TextBox(new_state, default_state["main_head_section_colored"])

	@property
	def main_head_section(self):
		self._getter_access_tracker["main_head_section"] = {}
		return self._main_head_section
	@main_head_section.setter
	def main_head_section(self, new_state):
		self._setter_access_tracker["main_head_section"] = {}
		global default_state
		self._main_head_section = TextBox(new_state, default_state["main_head_section"])

	@property
	def home_hero_section_text_desc(self):
		self._getter_access_tracker["home_hero_section_text_desc"] = {}
		return self._home_hero_section_text_desc
	@home_hero_section_text_desc.setter
	def home_hero_section_text_desc(self, new_state):
		self._setter_access_tracker["home_hero_section_text_desc"] = {}
		global default_state
		self._home_hero_section_text_desc = TextBox(new_state, default_state["home_hero_section_text_desc"])

	@property
	def button_flex_1_text(self):
		self._getter_access_tracker["button_flex_1_text"] = {}
		return self._button_flex_1_text
	@button_flex_1_text.setter
	def button_flex_1_text(self, new_state):
		self._setter_access_tracker["button_flex_1_text"] = {}
		global default_state
		self._button_flex_1_text = TextBox(new_state, default_state["button_flex_1_text"])
	...
	@property
	def man_asset_image(self):
		self._getter_access_tracker["man_asset_image"] = {}
		return self._man_asset_image
	@man_asset_image.setter
	def man_asset_image(self, new_state):
		self._setter_access_tracker["man_asset_image"] = {}
		global default_state
		self._man_asset_image = Image(new_state, default_state["man_asset_image"])
	...
	@property
	def menu_options_about(self):
		self._getter_access_tracker["menu_options_about"] = {}
		return self._menu_options_about
	@menu_options_about.setter
	def menu_options_about(self, new_state):
		self._setter_access_tracker["menu_options_about"] = {}
		global default_state
		self._menu_options_about = TextBox(new_state, default_state["menu_options_about"])

	@property
	def menu_options_service(self):
		self._getter_access_tracker["menu_options_service"] = {}
		return self._menu_options_service
	@menu_options_service.setter
	def menu_options_service(self, new_state):
		self._setter_access_tracker["menu_options_service"] = {}
		global default_state
		self._menu_options_service = TextBox(new_state, default_state["menu_options_service"])

	@property
	def menu_options_projects(self):
		self._getter_access_tracker["menu_options_projects"] = {}
		return self._menu_options_projects
	@menu_options_projects.setter
	def menu_options_projects(self, new_state):
		self._setter_access_tracker["menu_options_projects"] = {}
		global default_state
		self._menu_options_projects = TextBox(new_state, default_state["menu_options_projects"])

	@property
	def menu_options_blog(self):
		self._getter_access_tracker["menu_options_blog"] = {}
		return self._menu_options_blog
	@menu_options_blog.setter
	def menu_options_blog(self, new_state):
		self._setter_access_tracker["menu_options_blog"] = {}
		global default_state
		self._menu_options_blog = TextBox(new_state, default_state["menu_options_blog"])

	@property
	def menu_options_book(self):
		self._getter_access_tracker["menu_options_book"] = {}
		return self._menu_options_book
	@menu_options_book.setter
	def menu_options_book(self, new_state):
		self._setter_access_tracker["menu_options_book"] = {}
		global default_state
		self._menu_options_book = TextBox(new_state, default_state["menu_options_book"])
	...
	@property
	def trusted_by_1(self):
		self._getter_access_tracker["trusted_by_1"] = {}
		return self._trusted_by_1
	@trusted_by_1.setter
	def trusted_by_1(self, new_state):
		self._setter_access_tracker["trusted_by_1"] = {}
		global default_state
		self._trusted_by_1 = Image(new_state, default_state["trusted_by_1"])

	@property
	def trusted_by_2(self):
		self._getter_access_tracker["trusted_by_2"] = {}
		return self._trusted_by_2
	@trusted_by_2.setter
	def trusted_by_2(self, new_state):
		self._setter_access_tracker["trusted_by_2"] = {}
		global default_state
		self._trusted_by_2 = Image(new_state, default_state["trusted_by_2"])

	@property
	def trusted_by_3(self):
		self._getter_access_tracker["trusted_by_3"] = {}
		return self._trusted_by_3
	@trusted_by_3.setter
	def trusted_by_3(self, new_state):
		self._setter_access_tracker["trusted_by_3"] = {}
		global default_state
		self._trusted_by_3 = Image(new_state, default_state["trusted_by_3"])

	@property
	def trusted_by_4(self):
		self._getter_access_tracker["trusted_by_4"] = {}
		return self._trusted_by_4
	@trusted_by_4.setter
	def trusted_by_4(self, new_state):
		self._setter_access_tracker["trusted_by_4"] = {}
		global default_state
		self._trusted_by_4 = Image(new_state, default_state["trusted_by_4"])
	...
	@property
	def services_1_image(self):
		self._getter_access_tracker["services_1_image"] = {}
		return self._services_1_image
	@services_1_image.setter
	def services_1_image(self, new_state):
		self._setter_access_tracker["services_1_image"] = {}
		global default_state
		self._services_1_image = Image(new_state, default_state["services_1_image"])
	...
	@property
	def services_2_image(self):
		self._getter_access_tracker["services_2_image"] = {}
		return self._services_2_image
	@services_2_image.setter
	def services_2_image(self, new_state):
		self._setter_access_tracker["services_2_image"] = {}
		global default_state
		self._services_2_image = Image(new_state, default_state["services_2_image"])
	...
	@property
	def services_3_image(self):
		self._getter_access_tracker["services_3_image"] = {}
		return self._services_3_image
	@services_3_image.setter
	def services_3_image(self, new_state):
		self._setter_access_tracker["services_3_image"] = {}
		global default_state
		self._services_3_image = Image(new_state, default_state["services_3_image"])
	...
	@property
	def productDesginer1_image(self):
		self._getter_access_tracker["productDesginer1_image"] = {}
		return self._productDesginer1_image
	@productDesginer1_image.setter
	def productDesginer1_image(self, new_state):
		self._setter_access_tracker["productDesginer1_image"] = {}
		global default_state
		self._productDesginer1_image = Image(new_state, default_state["productDesginer1_image"])

	@property
	def productDesginer2_image(self):
		self._getter_access_tracker["productDesginer2_image"] = {}
		return self._productDesginer2_image
	@productDesginer2_image.setter
	def productDesginer2_image(self, new_state):
		self._setter_access_tracker["productDesginer2_image"] = {}
		global default_state
		self._productDesginer2_image = Image(new_state, default_state["productDesginer2_image"])

	@property
	def productDesginer3_image(self):
		self._getter_access_tracker["productDesginer3_image"] = {}
		return self._productDesginer3_image
	@productDesginer3_image.setter
	def productDesginer3_image(self, new_state):
		self._setter_access_tracker["productDesginer3_image"] = {}
		global default_state
		self._productDesginer3_image = Image(new_state, default_state["productDesginer3_image"])

	@property
	def productDesginer4_image(self):
		self._getter_access_tracker["productDesginer4_image"] = {}
		return self._productDesginer4_image
	@productDesginer4_image.setter
	def productDesginer4_image(self, new_state):
		self._setter_access_tracker["productDesginer4_image"] = {}
		global default_state
		self._productDesginer4_image = Image(new_state, default_state["productDesginer4_image"])
	...
	@property
	def we_1_image(self):
		self._getter_access_tracker["we_1_image"] = {}
		return self._we_1_image
	@we_1_image.setter
	def we_1_image(self, new_state):
		self._setter_access_tracker["we_1_image"] = {}
		global default_state
		self._we_1_image = Image(new_state, default_state["we_1_image"])
	...
	@property
	def Accordion8(self):
		self._getter_access_tracker["Accordion8"] = {}
		return self._Accordion8
	@Accordion8.setter
	def Accordion8(self, new_state):
		self._setter_access_tracker["Accordion8"] = {}
		global default_state
		self._Accordion8 = Accordion(new_state, default_state["Accordion8"])

	@property
	def Accordion9(self):
		self._getter_access_tracker["Accordion9"] = {}
		return self._Accordion9
	@Accordion9.setter
	def Accordion9(self, new_state):
		self._setter_access_tracker["Accordion9"] = {}
		global default_state
		self._Accordion9 = Accordion(new_state, default_state["Accordion9"])
	...
	def Accordion7(self, new_state):
		...
		global default_state
		self._Accordion7 = Accordion(new_state, default_state["Accordion7"])

	@property
	def Accordion10(self):
		self._getter_access_tracker["Accordion10"] = {}
		return self._Accordion10
	@Accordion10.setter
	def Accordion10(self, new_state):
		self._setter_access_tracker["Accordion10"] = {}
		global default_state
		self._Accordion10 = Accordion(new_state, default_state["Accordion10"])
	...
	def _to_json_fields(self):
		return {
			"home_hero_section": self._home_hero_section,
			"home_hero_section_flex": self._home_hero_section_flex,
			"home_hero_section_wrapper_text": self._home_hero_section_wrapper_text,
			"Flex10": self._Flex10,
			"button_flex_1": self._button_flex_1,
			"button_flex_2": self._button_flex_2,
			"home_hero_section_wrapper_image": self._home_hero_section_wrapper_image,
			"header": self._header,
			"header_flex": self._header_flex,
			"header_flex_menu": self._header_flex_menu,
			"trusted_by_section": self._trusted_by_section,
			"trusted_by_section_wrapper": self._trusted_by_section_wrapper,
			"Flex17": self._Flex17,
			"Flex18": self._Flex18,
			"Flex19": self._Flex19,
			"Flex20": self._Flex20,
			...
			"Flex22": self._Flex22,
			"Flex23": self._Flex23,
			"services_section": self._services_section,
			"Flex25": self._Flex25,
			"Flex26": self._Flex26,
			"Flex27": self._Flex27,
			"Flex28": self._Flex28,
			"Flex29": self._Flex29,
			"services_1": self._services_1,
			"Flex34": self._Flex34,
			"Flex35": self._Flex35,
			"Flex44": self._Flex44,
			"Flex45": self._Flex45,
			...
			"Flex56": self._Flex56,
			"Flex57": self._Flex57,
			"projects_section": self._projects_section,
			"Flex79": self._Flex79,
			"Flex81": self._Flex81,
			"Flex82": self._Flex82,
			"Flex80": self._Flex80,
			"product_designer_section": self._product_designer_section,
			"Flex86": self._Flex86,
			"Flex87": self._Flex87,
			"Flex88": self._Flex88,
			"Flex89": self._Flex89,
			...
			"main_head_section_colored": self._main_head_section_colored,
			"main_head_section": self._main_head_section,
			"home_hero_section_text_desc": self._home_hero_section_text_desc,
			"button_flex_1_text": self._button_flex_1_text,
			"TextBox14": self._TextBox14,
			"man_asset_image": self._man_asset_image,
			"Image1": self._Image1,
			"menu_options_about": self._menu_options_about,
			"menu_options_service": self._menu_options_service,
			"menu_options_projects": self._menu_options_projects,
			"menu_options_blog": self._menu_options_blog,
			"menu_options_book": self._menu_options_book,
			"TextBox15": self._TextBox15,
			"trusted_by_1": self._trusted_by_1,
			"trusted_by_2": self._trusted_by_2,
			"trusted_by_3": self._trusted_by_3,
			"trusted_by_4": self._trusted_by_4,
			"TextBox16": self._TextBox16,
			"TextBox17": self._TextBox17,
			"services_1_image": self._services_1_image,
			...
			"services_2_image": self._services_2_image,
			...
			"services_3_image": self._services_3_image,
			...
			"productDesginer1_image": self._productDesginer1_image,
			"productDesginer2_image": self._productDesginer2_image,
			"productDesginer3_image": self._productDesginer3_image,
			"productDesginer4_image": self._productDesginer4_image,
			"TextBox57": self._TextBox57,
			"TextBox58": self._TextBox58,
			"TextBox59": self._TextBox59,
			"TextBox60": self._TextBox60,
			"we_1_image": self._we_1_image,
			...
			"Accordion8": self._Accordion8,
			"Accordion9": self._Accordion9,
			"Accordion19": self._Accordion19,
			"Accordion6": self._Accordion6,
			"Accordion7": self._Accordion7,
			"Accordion10": self._Accordion10,
